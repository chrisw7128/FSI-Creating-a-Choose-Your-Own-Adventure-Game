...
if(firstAnswer == 'left'){
    let secondAnswer = window.prompt(`You come across a stray cat. It scampers off down a small hole, just large enough for you to crawl through. Do you follow it, or continue on your path? (follow or stay)`)
    ...
    if(secondAnswer == 'past the dragon'){
        let thirdAnswer = window.prompt('The dragon wakes up and sits upright. You only have a moment to respond, to stay or run: got the treasure. (stay or run)')
        if(thirdAnswer = 'stay'){
